...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MDBasicInfo_MDBasicInfo_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_MDBasicInfo_MDBasicInfo_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_MDBasicInfo_2eproto[1];
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::com::htsc::mdc::insight::model::MDBasicInfo)},
};
...
const char descriptor_table_protodef_MDBasicInfo_2eproto[] =
  ...
  " \001(\t\022\032\n\022FITradeProductType\030P \001(\t\022\032\n\022FISe"
  "curityProperty\030Q \001(\t\022\030\n\020FISecurityStatus"
  "\030R \001(\t\022\033\n\023FIPledgedSecurityID\030S \001(\t\022\022\n\nF"
  "IOpenTime\030T \001(\t\022\023\n\013FICloseTime\030U \001(\t\022\023\n\013"
  "FIIssueMode\030V \001(\t\022\024\n\014FIFaceAmount\030W \001(\001\022"
  "\024\n\014FIIssuePrice\030X \001(\001\022\026\n\016FIInterestType\030"
  "Y \001(\t\022\033\n\023FIInterestFrequency\030Z \001(\t\022 \n\030FI"
  "GuaranteedInterestRate\030[ \001(\001\022\032\n\022FIBaseIn"
  "terestRate\030\\ \001(\001\022\026\n\016FIQuotedMargin\030] \001(\001"
  "\022\023\n\013FITimeLimit\030^ \001(\005\022\027\n\017FITotalIssuance"
  "\030_ \001(\001\022\030\n\020FIIssueStartDate\030` \001(\t\022\026\n\016FIIs"
  "sueEndDate\030a \001(\t\022\022\n\nFIListDate\030b \001(\t\022\024\n\014"
  "FIExpireDate\030c \001(\t\022\032\n\022FINationalDebtType"
  "\030d \001(\t\022\025\n\rFIIssueMethod\030e \001(\t\022\025\n\rFICross"
  "Market\030f \001(\010\022\027\n\017FIShortSellFlag\030g \001(\010\022\035\n"
  "\025FITotalShortSellQuota\030h \001(\001\022\036\n\026FIDealer"
  "ShortSellQuota\030i \001(\001\022\024\n\014FIPreClosePx\030j \001"
  "(\001\022\027\n\017FIPreWeightedPx\030k \001(\001\022\026\n\016OptionLis"
  "tType\030n \001(\t\022\032\n\022OptionDeliveryType\030o \001(\t\022"
  "\031\n\021OptionAdjustTimes\030p \001(\005\022\036\n\026OptionCont"
  "ractPosition\030q \001(\003\022\036\n\026OptionBuyQtyUpperL"
  "imit\030r \001(\003\022\037\n\027OptionSellQtyUpperLimit\030s "
  "\001(\003\022)\n!OptionMarketOrderBuyQtyUpperLimit"
  "\030t \001(\003\022*\n\"OptionMarketOrderSellQtyUpperL"
  "imit\030u \001(\003\022(\n OptionQuoteOrderBuyQtyUppe"
  "rLimit\030v \001(\003\022)\n!OptionQuoteOrderSellQtyU"
  "pperLimit\030w \001(\003\022\030\n\020OptionBuyQtyUnit\030x \001("
  "\003\022\031\n\021OptionSellQtyUnit\030y \001(\003\022\034\n\024OptionLa"
  "stSellMargin\030z \001(\001\022\030\n\020OptionSellMargin\030{"
  " \001(\001\022\035\n\025OptionMarketMakerFlag\030| \001(\t\022!\n\031O"
  "ptionCombinationStrategy\030} \001(\t\022\024\n\014Delive"
  "ryYear\030~ \001(\t\022\025\n\rDeliveryMonth\030\177 \001(\t\022\025\n\014I"
  "nstrumentID\030\200\001 \001(\t\022\027\n\016InstrumentName\030\201\001 "
  "\001(\t\022\027\n\016ExchangeInstID\030\202\001 \001(\t\022\022\n\tProductI"
  "D\030\203\001 \001(\t\022\035\n\024MaxMarketOrderVolume\030\204\001 \001(\003\022"
  "\035\n\024MinMarketOrderVolume\030\205\001 \001(\003\022\034\n\023MaxLim"
  "itOrderVolume\030\206\001 \001(\003\022\034\n\023MinLimitOrderVol"
  "ume\030\207\001 \001(\003\022\027\n\016VolumeMultiple\030\210\001 \001(\003\022\023\n\nC"
  "reateDate\030\211\001 \001(\t\022\023\n\nExpireDate\030\212\001 \001(\t\022\027\n"
  "\016StartDelivDate\030\213\001 \001(\t\022\025\n\014EndDelivDate\030\214"
  "\001 \001(\t\022\025\n\014PositionType\030\215\001 \001(\t\022\030\n\017LongMarg"
  "inRatio\030\216\001 \001(\001\022\031\n\020ShortMarginRatio\030\217\001 \001("
  "\001\022\037\n\026MaxMarginSideAlgorithm\030\220\001 \001(\t\022\024\n\013St"
  "rikePrice\030\221\001 \001(\001\022\030\n\017PreOpenInterest\030\222\001 \001"
  "(\001\022\025\n\014FormerSymbol\030\223\001 \001(\t\022\023\n\nDelistDate\030"
  "\224\001 \001(\t\022\023\n\nBuyQtyUnit\030\225\001 \001(\003\022\024\n\013SellQtyUn"
  "it\030\226\001 \001(\003\022\031\n\020BuyQtyUpperLimit\030\241\001 \001(\003\022\032\n\021"
  "SellQtyUpperLimit\030\242\001 \001(\003\022\031\n\020BuyQtyLowerL"
  "imit\030\243\001 \001(\003\022\032\n\021SellQtyLowerLimit\030\244\001 \001(\003B"
  "4\n\032com.htsc.mdc.insight.modelB\021MDBasicIn"
  "foProtosH\001\240\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_MDBasicInfo_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDBasicInfo_2eproto = {
  &descriptor_table_MDBasicInfo_2eproto_initialized, descriptor_table_protodef_MDBasicInfo_2eproto, "MDBasicInfo.proto", 3821,
  &descriptor_table_MDBasicInfo_2eproto_once, descriptor_table_MDBasicInfo_2eproto_sccs, descriptor_table_MDBasicInfo_2eproto_deps, 1, 2,
  schemas, file_default_instances, TableStruct_MDBasicInfo_2eproto::offsets,
  file_level_metadata_MDBasicInfo_2eproto, 1, file_level_enum_descriptors_MDBasicInfo_2eproto, file_level_service_descriptors_MDBasicInfo_2eproto,
};
...
MDBasicInfo::MDBasicInfo(const MDBasicInfo& from)
  ...
  ::memcpy(&securityidsource_, &from.securityidsource_,
    static_cast<size_t>(reinterpret_cast<char*>(&sellqtylowerlimit_) -
    reinterpret_cast<char*>(&securityidsource_)) + sizeof(sellqtylowerlimit_));
...
void MDBasicInfo::SharedCtor() {
  ...
  ::memset(&securityidsource_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&sellqtylowerlimit_) -
      reinterpret_cast<char*>(&securityidsource_)) + sizeof(sellqtylowerlimit_));
}
