...
const char descriptor_table_protodef_MDQBQuote_2eproto[] =
  ...
  "ype\030\036 \001(\005B2\n\032com.htsc.mdc.insight.modelB"
  "\017MDQBQuoteProtosH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDQBQuote_2eproto = {
  &descriptor_table_MDQBQuote_2eproto_initialized, descriptor_table_protodef_MDQBQuote_2eproto, "MDQBQuote.proto", 869,
...
MDQBQuote::MDQBQuote(const MDQBQuote& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&brokerdatatype_) -
    reinterpret_cast<char*>(&mddate_)) + sizeof(brokerdatatype_));
...
void MDQBQuote::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&brokerdatatype_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(brokerdatatype_));
}
