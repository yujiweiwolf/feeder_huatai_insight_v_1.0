...
const char descriptor_table_protodef_MDSLTransaction_2eproto[] =
  ...
  "\020\n\010TradeNum\030\023 \001(\tB8\n\032com.htsc.mdc.insigh"
  "t.modelB\025MDSLTransactionProtosH\001\240\001\001b\006pro"
  "to3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDSLTransaction_2eproto = {
  &descriptor_table_MDSLTransaction_2eproto_initialized, descriptor_table_protodef_MDSLTransaction_2eproto, "MDSLTransaction.proto", 643,
...
MDSLTransaction::MDSLTransaction(const MDSLTransaction& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&tradeterm_) -
    reinterpret_cast<char*>(&mddate_)) + sizeof(tradeterm_));
...
void MDSLTransaction::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&tradeterm_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(tradeterm_));
}
