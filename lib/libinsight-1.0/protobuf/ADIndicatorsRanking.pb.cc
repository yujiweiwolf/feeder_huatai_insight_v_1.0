...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ADIndicatorsRanking_2eproto = {
  &descriptor_table_ADIndicatorsRanking_2eproto_initialized, descriptor_table_protodef_ADIndicatorsRanking_2eproto, "ADIndicatorsRanking.proto", 608,
...
void ADIndicatorsRanking::SharedCtor() {
  ...
  ::memset(&typicalvalue_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&typicalvalue_)) + sizeof(exchangetime_));
}
