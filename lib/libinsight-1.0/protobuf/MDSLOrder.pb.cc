...
const char descriptor_table_protodef_MDSLOrder_2eproto[] =
  ...
  "\017 \001(\tB2\n\032com.htsc.mdc.insight.modelB\017MDS"
  "LOrderProtosH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDSLOrder_2eproto = {
  &descriptor_table_MDSLOrder_2eproto_initialized, descriptor_table_protodef_MDSLOrder_2eproto, "MDSLOrder.proto", 545,
...
MDSLOrder::MDSLOrder(const MDSLOrder& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&orderterm_) -
    reinterpret_cast<char*>(&mddate_)) + sizeof(orderterm_));
...
void MDSLOrder::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&orderterm_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(orderterm_));
}
