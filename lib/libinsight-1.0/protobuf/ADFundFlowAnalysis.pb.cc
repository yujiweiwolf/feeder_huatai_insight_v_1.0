...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 23, -1, sizeof(::com::htsc::mdc::insight::model::ADFundFlowDetail)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ADFundFlowAnalysis_2eproto = {
  &descriptor_table_ADFundFlowAnalysis_2eproto_initialized, descriptor_table_protodef_ADFundFlowAnalysis_2eproto, "ADFundFlowAnalysis.proto", 1257,
...
void ADFundFlowAnalysis::SharedCtor() {
  ...
  ::memset(&superlargeorder_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&superlargeorder_)) + sizeof(exchangetime_));
}
