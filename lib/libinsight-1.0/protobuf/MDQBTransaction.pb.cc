...
const char descriptor_table_protodef_MDQBTransaction_2eproto[] =
  ...
  "ime\030\034 \001(\003B8\n\032com.htsc.mdc.insight.modelB"
  "\025MDQBTransactionProtosH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDQBTransaction_2eproto = {
  &descriptor_table_MDQBTransaction_2eproto_initialized, descriptor_table_protodef_MDQBTransaction_2eproto, "MDQBTransaction.proto", 835,
...
MDQBTransaction::MDQBTransaction(const MDQBTransaction& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&transacttime_) -
    reinterpret_cast<char*>(&mddate_)) + sizeof(transacttime_));
