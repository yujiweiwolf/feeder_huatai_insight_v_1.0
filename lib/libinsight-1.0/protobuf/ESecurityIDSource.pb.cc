...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ESecurityIDSource_2eproto = {
  &descriptor_table_ESecurityIDSource_2eproto_initialized, descriptor_table_protodef_ESecurityIDSource_2eproto, "ESecurityIDSource.proto", 855,
