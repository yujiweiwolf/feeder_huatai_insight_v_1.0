...
const char descriptor_table_protodef_MDOption_2eproto[] =
  ...
  "\003(\003B\002\020\001B1\n\032com.htsc.mdc.insight.modelB\016M"
  "DOptionProtosH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDOption_2eproto = {
  &descriptor_table_MDOption_2eproto_initialized, descriptor_table_protodef_MDOption_2eproto, "MDOption.proto", 1506,
...
MDOption::MDOption(const MDOption& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&channelno_) -
...
void MDOption::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&channelno_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(channelno_));
}
