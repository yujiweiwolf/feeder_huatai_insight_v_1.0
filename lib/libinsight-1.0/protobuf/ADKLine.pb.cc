...
const char descriptor_table_protodef_ADKLine_2eproto[] =
  ...
  "\rADKLineProtosH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ADKLine_2eproto = {
  &descriptor_table_ADKLine_2eproto_initialized, descriptor_table_protodef_ADKLine_2eproto, "ADKLine.proto", 1027,
...
ADKLine::ADKLine(const ADKLine& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&closeyield_) -
...
void ADKLine::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&closeyield_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(closeyield_));
}
