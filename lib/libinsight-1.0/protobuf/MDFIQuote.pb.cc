...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDFIQuote_2eproto = {
  &descriptor_table_MDFIQuote_2eproto_initialized, descriptor_table_protodef_MDFIQuote_2eproto, "MDFIQuote.proto", 1085,
...
MDFIQuote::MDFIQuote(const MDFIQuote& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&sellexercisetype_) -
    reinterpret_cast<char*>(&mddate_)) + sizeof(sellexercisetype_));
...
void MDFIQuote::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&sellexercisetype_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(sellexercisetype_));
}
