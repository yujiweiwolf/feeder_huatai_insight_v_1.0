...
const char descriptor_table_protodef_MDUSATransaction_2eproto[] =
  ...
  "um\030\032 \001(\005B9\n\032com.htsc.mdc.insight.modelB\026"
  "MDUSATransactionProtosH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MDUSATransaction_2eproto = {
  &descriptor_table_MDUSATransaction_2eproto_initialized, descriptor_table_protodef_MDUSATransaction_2eproto, "MDUSATransaction.proto", 835,
...
MDUSATransaction::MDUSATransaction(const MDUSATransaction& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&trackingnum_) -
    reinterpret_cast<char*>(&mddate_)) + sizeof(trackingnum_));
...
void MDUSATransaction::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&trackingnum_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(trackingnum_));
}
