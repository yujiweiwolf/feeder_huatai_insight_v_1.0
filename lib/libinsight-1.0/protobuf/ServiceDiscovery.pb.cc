...
const char descriptor_table_protodef_ServiceDiscovery_2eproto[] =
  ...
  "iscoveryProtoH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ServiceDiscovery_2eproto = {
  &descriptor_table_ServiceDiscovery_2eproto_initialized, descriptor_table_protodef_ServiceDiscovery_2eproto, "ServiceDiscovery.proto", 506,
...
ServerInfo::ServerInfo(const ServerInfo& from)
  ...
  ::memcpy(&port_, &from.port_,
    static_cast<size_t>(reinterpret_cast<char*>(&iptype_) -
