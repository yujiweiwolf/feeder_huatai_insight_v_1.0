...
const char descriptor_table_protodef_ADStaringResult_2eproto[] =
  ...
  "Value\030\020 \001(\003B8\n\032com.htsc.mdc.insight.mode"
  "lB\025ADStaringResultProtosH\001\240\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ADStaringResult_2eproto = {
  &descriptor_table_ADStaringResult_2eproto_initialized, descriptor_table_protodef_ADStaringResult_2eproto, "ADStaringResult.proto", 597,
...
ADStaringResult::ADStaringResult(const ADStaringResult& from)
  ...
  ::memcpy(&mddate_, &from.mddate_,
    static_cast<size_t>(reinterpret_cast<char*>(&realcalvalue_) -
    reinterpret_cast<char*>(&mddate_)) + sizeof(realcalvalue_));
...
void ADStaringResult::SharedCtor() {
  ...
  ::memset(&mddate_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&realcalvalue_) -
      reinterpret_cast<char*>(&mddate_)) + sizeof(realcalvalue_));
}
